...
maintainer through either of the following channels:

- **Maintainer's Email:** [camilo@ccueto.com](mailto:camilo@ccueto.com)
- **GitHub private report:
  ** [github.com/ccuetoh/sriracha/security/advisories/new](https://github.com/ccuetoh/sriracha/security/advisories/new) —
  select "Report a vulnerability" and label the report as a Code of Conduct issue in the title.

All reports are handled confidentially. You can expect an initial acknowledgement within **7 days**, mirroring the
response window in [`SECURITY.md`](SECURITY.md).
