...
func TestFingerprint_GoldenVector(t *testing.T) {
	...
	const want = "85025077c02034e042b3adfa01ea7a2eb7785c7d4623fb1de600f0b11f241e51"
	got := fs.Fingerprint()
	if got != want {
...
func TestFingerprint_SensitivityMatrix(t *testing.T) {
	...
	cases := []struct {
		...
		{"BalancedChange", mutate(func(fs *FieldSet) { fs.ProbabilisticParams.Balanced = true }).Fingerprint()},
	}
